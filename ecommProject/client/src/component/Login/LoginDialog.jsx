  ...
  return (
    <div>
      <Dialog open={open} onClose={handleClose} PaperProps={{ sx : { maxWidth : 'unset'} }} >
        ...
        <ContainerBox>
          <Box style={{ backgroundColor: '#e94d1c', width: '34%', padding: '2rem 2rem' }}>
         ...
         { account.view === 'login' ?
          ...
          { error &&  <Error>Invalid email or password</Error> }
            ...
            <Typography style={{fontSize : '0.75rem' , color : 'var(--font-grey)' }} >By continuing, you agree to Bookchor's Terms of use & policy.</Typography>
            ...
            <CreateAcc onClick={()=> setAccount(accountValue.signUp) } >New to BookChor? Create an account </CreateAcc>
